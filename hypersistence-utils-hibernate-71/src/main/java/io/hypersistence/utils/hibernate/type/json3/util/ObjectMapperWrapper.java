package io.hypersistence.utils.hibernate.type.json3.util;
...
public class ObjectMapperWrapper implements Serializable {
    ...
    private static final ObjectMapper OBJECT_MAPPER = JsonMapper.builder()
        .addModule(new SimpleModule().addSerializer(OffsetDateTime.class, OffsetDateTimeSerializer.INSTANCE)
    ...
    private io.hypersistence.utils.hibernate.type.util.JsonSerializer jsonSerializer = new ObjectMapperJsonSerializer(this);
  ...
  public static class OffsetDateTimeSerializer extends ValueSerializer<OffsetDateTime> {
        ...
        @Override
        public void serialize(OffsetDateTime offsetDateTime, JsonGenerator jsonGenerator, SerializationContext ctxt) throws JacksonException {
    ...
    public static class OffsetDateTimeDeserializer extends ValueDeserializer<OffsetDateTime> {
        ...
        public OffsetDateTime deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws JacksonException {
            if (jsonParser.getString() != null) {
                try {
                    return OffsetDateTime.parse(jsonParser.getString(), ISO_OFFSET_DATE_TIME);
